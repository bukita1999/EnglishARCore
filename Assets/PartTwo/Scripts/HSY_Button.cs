...
public class HSY_Button : MonoBehaviour, IPointerClickHandler, IPointerDownHandler
{
    ...
    public void OnPointerDown(PointerEventData eventData)
    {
        ...
        {
            //HHHHHHHHHHHHHHHHHitem.transform.parent.gameObject.GetComponent<ZYC_AugmentedImageVisualizer>().isOverImage = false;
            //item.GetComponent<Rigidbody>().mass=item.GetComponent<Rigidbody>().mass*=10;
